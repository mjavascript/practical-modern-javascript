...
Besides new built-ins, ES6 comes with several updates to `Number`, `Math`, `Array`, and ((("Number")))((("Math")))((("Array")))((("strings")))strings. In <<built-in-improvements-in-es6>> we'll go over a plethora of new instance and static methods added to these built-ins.
