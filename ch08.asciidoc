...
image::images/pmjs_09in01.png["Printing an item for our grocery shopping list"]
...
image::images/pmjs_09in02.png["Printing a grocery shopping list"]
...
image::images/pmjs_09in03.png["Printing different views through a normalized render function."]
