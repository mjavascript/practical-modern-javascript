...
An ((("preventExtensions trap", startref="pet6")))((("traps", "preventExtensions trap", startref="t6pet")))((("proxies", "preventExtensions trap", startref="prox6pet")))extensible object is an object that you can add new properties to, an object you can extend.
