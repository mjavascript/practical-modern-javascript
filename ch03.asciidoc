...
With all the fluff around immutability you may be tempted to return a new property descriptor from your ((("Decorators", "descriptors in", startref="dec3d")))((("descriptors", startref="d3")))decorators, without modifying the original descriptor. While well-intentioned, this may have an undesired effect, as it is possible to decorate the same `class` or class member several times.
