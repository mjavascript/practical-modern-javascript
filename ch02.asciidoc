...
Because arrow functions don't have their own `arguments` keyword, the lookup bubbles up to the outer scope of the `puzzle` function. That means the printed arguments will be `'a', 'b', 'c'`.
