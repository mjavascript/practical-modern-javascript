...
<pre data-type="programlisting" data-code-language="javascript">const text = '\ud83d\udc0e\ud83d\udc71\u2764'
[...text].reverse().join('')
// &lt;- '<img src="images/2764.png" alt="❤️" data-emoji-embed="❤️" /><img src="images/1f471.png" alt="man" data-emoji-embed="smiling idiot"/><img src="images/1f40e.png" alt="horse" data-emoji-embed="running horse" />'</pre>
++++
