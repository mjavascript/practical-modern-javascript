...
For code points beyond `U+FFFF`, you'd represent them as a surrogate pair. That is to say, two contiguous code units. For instance, the horse emoji `'<img src="images/1f40e.svg"/>'` code point is represented with the `'\ud83d\udc0e'` contiguous code units. In ES6 notation you can also represent code points using the `'\u{1f40e}'` notation (that example is also the horse emoji).
...
// &lt;- '<img src="images/1f40e.svg"/><img src="images/1f471.svg"/><img src="images/2764.svg"/>'</pre>
++++
...
// &lt;- 5
'<img src="images/1f40e.svg"/><img src="images/1f471.svg"/><img src="images/2764.svg"/>'.length
// &lt;- 5, still</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">Object.keys('<img src="images/1f40e.svg"/><img src="images/1f471.svg"/><img src="images/2764.svg"/>')
// &lt;- ['0', '1', '2', '3', '4']</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">const text = '<img src="images/1f40e.svg"/><img src="images/1f471.svg"/><img src="images/2764.svg"/>'
...
++++
<pre data-type="programlisting" data-code-language="javascript">for (const codePoint of '<img src="images/1f40e.svg"/><img src="images/1f471.svg"/><img src="images/2764.svg"/>') {
  console.log(codePoint)
  // &lt;- '<img src="images/1f40e.svg"/>'
  // &lt;- '<img src="images/1f471.svg"/>'
  // &lt;- '<img src="images/2764.svg"/>'
}</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">[...'<img src="images/1f40e.svg"/><img src="images/1f471.svg"/><img src="images/2764.svg"/>'].length
// &lt;- 3</pre>
++++
...
<pre data-type="programlisting" data-code-language="javascript">const text = '\ud83d\udc0e\ud83d\udc71\u2764'
[...text].reverse().join('')
// &lt;- '<img src="images/2764.svg"/><img src="images/1f471.svg"/><img src="images/1f40e.svg"/>'</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">/\u{1f40e}/.test('<img src="images/1f40e.svg"/>') // &lt;- false
...
++++
<pre data-type="programlisting" data-code-language="javascript">/\u{1f40e}/u.test('<img src="images/1f40e.svg"/>')
// &lt;- true</pre>
++++
