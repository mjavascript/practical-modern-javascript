...
Before ((("Array.from", id="af7")))ES6, JavaScript developers often needed to cast `arguments` to a function into an array.
...
The `Array.of` method ((("Array.from", startref="af7")))is exactly like the `cast` function we played around with earlier. Next is a code snippet that shows how `Array.of` might be ponyfilled.
