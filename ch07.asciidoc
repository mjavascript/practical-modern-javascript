...
This is the largest integer that can be safely and precisely represented in JavaScript, or any language that represents integers using floating point as specified by the IEEE-754 standardfootnoteref:[floating-point,IEEE 754 is the Floating Point Standard. On Wikipedia: https://mjavascript.com/out/floating-point.], for that matter. The next bit of code shows exactly how large `Number.MAX_SAFE_INTEGER` is.
...
Values in the `(-1, 0)` range are rounded to `-0` becase `count` is passed through `ToInteger`, as documented by the specificationfootnoteref:[array-repeat,`String#repeat` in ECMAScript 6 Specification, section 21.1.3.13: https://mjavascript.com/out/array-repeat.]. That step in the specification dictates that `count` be casted with a formula like the one in the next code snippet.
...
// &lt;- '<img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" /><img src="images/1f471.png" style="width: 16px" alt="👱" data-emoji-embed="👱" /><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'</pre>
++++
...
// &lt;- 5
'<img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" /><img src="images/1f471.png" style="width: 16px" alt="👱" data-emoji-embed="👱" /><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'.length
// &lt;- 5, still</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">Object.keys('<img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" /><img src="images/1f471.png" style="width: 16px" alt="👱" data-emoji-embed="👱" /><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />')
// &lt;- ['0', '1', '2', '3', '4']</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">const text = '<img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" /><img src="images/1f471.png" style="width: 16px" alt="👱" data-emoji-embed="👱" /><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'
...
++++
<pre data-type="programlisting" data-code-language="javascript">for (const codePoint of '<img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" /><img src="images/1f471.png" style="width: 16px" alt="👱" data-emoji-embed="👱" /><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />') {
  console.log(codePoint)
  // &lt;- '<img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" />'
  // &lt;- '<img src="images/1f471.png" style="width: 16px" alt="👱" data-emoji-embed="👱" />'
  // &lt;- '<img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'
}</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">[...'<img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" /><img src="images/1f471.png" style="width: 16px" alt="👱" data-emoji-embed="👱" /><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'].length
// &lt;- 3</pre>
++++
...
// &lt;- '<img src="images/1f471.png" style="width: 16px" alt="👱" data-emoji-embed="👱" />'
'\u{2764}'
// &lt;- '<img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'</pre>
++++
...
<pre data-type="programlisting" data-code-language="javascript">const text = '\ud83d\udc0e\ud83d\udc71\u2764'
[...text].reverse().join('')
// &lt;- '<img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" /><img src="images/1f471.png" style="width: 16px" alt="👱" data-emoji-embed="👱" /><img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" />'</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">/\u{1f40e}/.test('<img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" />') // &lt;- false
...
++++
<pre data-type="programlisting" data-code-language="javascript">/\u{1f40e}/u.test('<img src="images/1f40e.png" style="width: 16px" alt="🐎" data-emoji-embed="🐎" />')
// &lt;- true</pre>
++++
...
The proposed Unicode property escapesfootnoteref:[unicode-property-escapes,You can find the Unicode property escapes proposal document at: https://mjavascript.com/out/unicode-property-escapes.] (currently in stage 3) are a new kind of escape sequence that's available in regular expressions marked with the `u` flag. This proposal adds a escape in the form of `\p{LoneUnicodePropertyNameOrValue}` for binary Unicode properties and `\p{UnicodePropertyName=UnicodePropertyValue}` for non-binary Unicode properties. In addition, `\P` is the negated version of a `\p` escape sequence.
