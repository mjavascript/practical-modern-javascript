...
Luckily for us, in ES6 strings adhere to the iterable protocol. We can use the string iterator to go over code points, even when those code points are made of surrogate ((("Unicode", startref="u7")))((("strings", "and Unicode", startref="s7au")))pairs.
