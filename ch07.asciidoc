...
Given ((("String.prototype[Symbol.iterator]", id="spsi7")))((("strings", "splitting into code points", id="s7sicp")))the problems with looping by code units, the iterables produced by the string iterator yield code points instead.
...
This ((("String#codePointAt", startref="scpa7")))method takes in a number and returns a code point. Note how I can use the `0x` prefix with the terse base-16 code points we got from `String#codePointAt` moments ago.
