...
For code points beyond `U+FFFF`, you'd represent them as a surrogate pair. That is to say, two contiguous code units. For instance, the horse emoji pass:[<code><img src="images/1f40e.png" alt="ߐdata-emoji-embed="ߐwidth="16"/></code>] code point is represented with the `'\ud83d\udc0e'` contiguous code units. In ES6 notation you can also represent code points using the `'\u{1f40e}'` notation (that example is also the horse emoji).
...
// &lt;- '<img src="images/1f40e.png" alt="ߐdata-emoji-embed="ߐ><img src="images/1f471.png" style="width: 16px" alt="ߑᢠdata-emoji-embed="ߑ᢯><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'</pre>
++++
...
// &lt;- 5
'<img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ><img src="images/1f471.png" style="width: 16px" alt="ߑᢠdata-emoji-embed="ߑ᢯><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'.length
// &lt;- 5, still</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">Object.keys('<img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ/><img src="images/1f471.png" style="width: 16px" alt="ߑᢠdata-emoji-embed="ߑᢠ/><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />')
// &lt;- ['0', '1', '2', '3', '4']</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">const text = '<img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ/><img src="images/1f471.png" style="width: 16px" alt="ߑᢠdata-emoji-embed="ߑᢠ/><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'
...
++++
<pre data-type="programlisting" data-code-language="javascript">for (const codePoint of '<img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ/><img src="images/1f471.png" style="width: 16px" alt="ߑᢠdata-emoji-embed="ߑᢠ/><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />') {
  console.log(codePoint)
  // &lt;- '<img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ/>'
  // &lt;- '<img src="images/1f471.png" style="width: 16px" alt="ߑᢠdata-emoji-embed="ߑᢠ/>'
...
++++
<pre data-type="programlisting" data-code-language="javascript">[...'<img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ/><img src="images/1f471.png" style="width: 16px" alt="ߑᢠdata-emoji-embed="ߑᢠ/><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'].length
// &lt;- 3</pre>
++++
...
// &lt;- '<img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ/><img src="images/1f471.png" style="width: 16px" alt="ߑᢠdata-emoji-embed="ߑᢠ/><img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" />'</pre>
++++
...
<pre data-type="programlisting" data-code-language="javascript">const text = '\ud83d\udc0e\ud83d\udc71\u2764'
[...text].reverse().join('')
// &lt;- '<img src="images/2764.png" style="width: 16px" alt="❤️" data-emoji-embed="❤️" /><img src="images/1f471.png" style="width: 16px" alt="ߑᢠdata-emoji-embed="ߑᢠ/><img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ/>'</pre>
++++
...
++++
<pre data-type="programlisting" data-code-language="javascript">/\u{1f40e}/.test('<img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ/>') // &lt;- false
...
++++
<pre data-type="programlisting" data-code-language="javascript">/\u{1f40e}/u.test('<img src="images/1f40e.png" style="width: 16px" alt="ߐdata-emoji-embed="ߐ/>')
// &lt;- true</pre>
++++
