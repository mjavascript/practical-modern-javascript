...
Given ((("String.prototype[Symbol.iterator]", id="spsi7")))the problems with looping by code units, the iterables produced by the string iterator yield code points instead.
