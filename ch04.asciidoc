...
What ((("asynchronous functions", "async/await", startref="af4a")))about concurrent asynchronous flows?
...
We could use `Promise.race` to get the result from the promise that fulfills ((("asynchronous functions", "concurrent async flows", startref="af4caf")))quicker.
