...
Besides the technical implications of creating iterable objects, let's go over a couple of practical examples on how we can ((("iteration protocol", "infinite sequences", startref="ip4is")))benefit from iterators.
