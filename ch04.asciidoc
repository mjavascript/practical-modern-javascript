...
The `for..of` iteration method ((("iteration principles", "for..of method", id="ip4fom")))can be used to loop over any iterable. The following example demonstrates how we could use `for..of` to loop over the `sequence` object we put together in the previous example, because it is an iterable object.
...
Iterable sequences ((("iteration principles", "for..of method", startref="ip4fom")))aren't necessarily finite. They may have an uncountable amount of elements. Let's delve into that ((("iteration principles", startref="ip4")))topic and its implications.
