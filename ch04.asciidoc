...
Async functions ((("asynchronous functions", "await", id="af4a")))let us take a promise-based implementation and take advantage of the synchronous-looking generator style. A huge benefit in this approach is that you won't have to change the original `getRandomArticle` at all: as long as it returns a promise it can be awaited.
...
What ((("asynchronous functions", "await", startref="af4a")))about concurrent asynchronous flows?
